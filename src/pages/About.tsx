            ...
            <motion.div {...fadeUpLocal(0.05)} className="md:col-span-2 lg:col-span-3">
              <DarkCard>
                ...
                <div className="space-y-4 text-sm leading-relaxed text-white/75">
                  ...
                  <p>Bununla yanaşı, müasir bizneslərin rəqəmsal transformasiyasına xidmət edən iki böyük layihənin təsisçisi və baş memarıyam. Bunlar tamhüquqlu ERP sistemi olaraq fəaliyyət göstərən <a href="https://smartrestoran.cloud" target="_blank" rel="noopener noreferrer" className="font-bold text-primary hover:underline">Smart Restoran (smartrestoran.cloud)</a> və genişmiqyaslı elektron ticarət ekosistemi olan <a href="https://dadmarket.shop" target="_blank" rel="noopener noreferrer" className="font-bold text-primary hover:underline">DadMarket (dadmarket.shop)</a> Marketpleysidir. Bu layihələr sadəcə biznes ideyası deyil; texniki arxitekturasından tutmuş tam fəaliyyətinə qədər şəxsən layihələndirib sıfırdan ərsəyə gətirdiyim mürəkkəb rəqəmsal sistemlərdir.</p>
