  ...
  return (
    <section className="hero-batuhan relative overflow-hidden bg-black">
      ...
      >
        ...
        <LazyImage src={content.about_image || ABOUT_IMAGE} alt="Elvin Şahbazov" className="h-[110%] w-full object-cover object-[50%_40%] -translate-y-[5%]" />
      </motion.div>
            ...
            <motion.div {...fadeUpLocal(0.05)} className="md:col-span-2 lg:col-span-3">
              <DarkCard>
                ...
                <div className="space-y-4 text-sm leading-relaxed text-white/75">
                  ...
                  <p>Bununla yanaşı, müasir bizneslərin rəqəmsallaşmasına və böyüməsinə xidmət edən iki böyük layihənin təsisçisi və baş memarıyam. Bunlar restoran biznesləri üçün bulud əsaslı <strong className="text-white">SaaS</strong> modeli ilə qurulmuş, ERP sistemi olaraq fəaliyyət göstərən <a href="https://smartrestoran.cloud" target="_blank" rel="noopener noreferrer" className="font-bold text-primary hover:underline">Smart Restoran (smartrestoran.cloud)</a> layihəsi və genişmiqyaslı elektron ticarət ekosistemi olan <a href="https://dadmarket.shop" target="_blank" rel="noopener noreferrer" className="font-bold text-primary hover:underline">DadMarket (dadmarket.shop)</a> Marketpleysidir. Bu layihələr sadəcə biznes ideyası deyil; texniki arxitekturasından tutmuş tam fəaliyyətinə qədər şəxsən layihələndirib sıfırdan ərsəyə gətirdiyim mürəkkəb rəqəmsal sistemlərdir.</p>
                  ...
                  <p>Bu günə qədər <strong className="text-white">15-dən çox şirkət üçün</strong> rəqəmsal innovasiyaların tətbiqi, marketinq strategiyalarının hazırlanması, satış sistemlərinin qurulması və analitika əsaslı idarəetmə layihələrini uğurla həyata keçirmişəm.</p>
